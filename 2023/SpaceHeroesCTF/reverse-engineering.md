...
Sadly, while the competion's running, we did't know how to bypass it. Then after the event, thanks to `Gift1a` hints in Discord that using file patching, we solved that by patching binary with Ghidra
